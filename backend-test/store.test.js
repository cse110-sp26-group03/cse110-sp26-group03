...
/**
 * Updating an issue that isn't in the cache should fail before any write,
 * surfacing the "no issue with that ID exists" reason.
 */
...
/**
 * Deleting an issue that isn't in the cache should fail before any write,
 * surfacing the "no issue with that ID exists" reason.
 */
